var TutorialThreeScene = cc.Scene.extend({
    space: null,
	PhysicsDebug: false,
	debugDrawNode: null,
	background: null,
	...
	LEVEL_START_POSITION: cc.p(200, 320),
	...
	initializePauseMenu: function() {
		...
		var forwardButton = new cc.MenuItemImage(res.RightNormal, res.RightSelected, function() {
			cc.director.resume();
			cc.director.runScene(new TutorialFourScene());
		});
	...
	addObjects: function() {
		var objects = JSON.parse(JSON.stringify(TutorialThreeObjects));
