var LevelFourteenScene = cc.Scene.extend({
    space: null,
	PhysicsDebug: false,
	debugDrawNode: null,
	background: null,
	...
	LEVEL_START_POSITION: cc.p(120, 360),
	...
	INNER_COLOR: [0.4, 0.2, 0.2, 1.0],
	SHADOW_COLOR: [0.1, 0.05, 0.05, 1.0],
	LIMITATION_BACKGROUND_COLOR: [0.1, 0.05, 0.05, 1.0],
	...
	addObjects: function() {
		var objects = JSON.parse(JSON.stringify(LevelFourteenObjects));
	...
	createInvincibility: function() {
		if(this.light!= null) {
			if(this.light.Health > 1)
				this.light.RestoreHealth();
		}
	},
