var LevelFifteenScene = cc.Scene.extend({
    space: null,
	PhysicsDebug: false,
	debugDrawNode: null,
	background: null,
	...
	LEVEL_START_POSITION: cc.p(150, 345),
	...
	initializePauseMenu: function() {
		...
		var retryButton = new cc.MenuItemImage(res.RetryButtonNormal, res.RetryButtonSelected, function() {
			var scene = new LevelFifteenScene();
	...
	addObjects: function() {
		var objects = JSON.parse(JSON.stringify(LevelFifteenObjects));
