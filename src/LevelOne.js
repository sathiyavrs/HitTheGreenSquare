var LevelOneScene = cc.Scene.extend({
	...
	BACKGROUND_COLOR: [0.1, 0.4, 0.0, 1],
	INNER_COLOR: [0.1, 0.4, 0.0, 1.0],
	SHADOW_COLOR: [0.025, 0.1, 0.0, 1.0],
	LIMITATION_BACKGROUND_COLOR: [0.025, 0.1, 0.0, 1.0],
	...
	addObjects: function() {
		...
		var objects = JSON.parse(JSON.stringify(LevelOneObjects));
