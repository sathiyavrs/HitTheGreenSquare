var LevelTwelveScene = cc.Scene.extend({
	...
	LEVEL_START_POSITION: cc.p(200, 345),
	...
	INNER_COLOR: [0.1, 0.0, 0.2, 1.0],
	SHADOW_COLOR: [0.025, 0.0, 0.05, 1.0],
	LIMITATION_BACKGROUND_COLOR: [0.025, 0.00, 0.05, 1.0],
	...
	initializePauseMenu: function() {
		...
		var retryButton = new cc.MenuItemImage(res.RetryButtonNormal, res.RetryButtonSelected, function() {
			var scene = new LevelTwelveScene();
	...
	addObjects: function() {
		var objects = JSON.parse(JSON.stringify(LevelTwelveObjects));
